      ...
      return (
        <div className='bg-home flex flex-col items-center justify-center mt-20'>
          ...
          <div className='flex flex-col items-center text-center mt-10 md:mt-20 mb-20'>
            <img src={one} className='w-auto  h-auto' alt="Imagen de fondo" />
            ...
            <img src={one_two} className='w-auto h-auto' alt="Imagen de fondo" />
          </div>
        ...
        <div className='mt-20 mb-20'>
            <img src={three} className='w-full h-auto' alt="Imagen de fondo" />
            <div className='relative'>
              <img src={three_three} className='md:w-5/6 w-full h-auto ml-auto' alt="Imagen de fondo" />
          ...
          <div className='relative mb-20'>
            <img src={four} className='w-full h-auto' alt="Imagen de fondo" />
            <div className='absolute inset-0 flex items-center justify-center p-4'>
          ...
          <div className='relative mb-20'>
            <img src={five} className='w-full h-auto' alt="Imagen de fondo" />
            <div className='absolute inset-0 flex items-center justify-center p-4'>
              <p className=' font-light text-customBlue4 opacity-90 xl:text-extra-large lg:text-3xl md:text-lg text-base italic leading-none'>
          ...
          <div className='relative mb-20'>
            <img src={six} className='md:w-4/5 w-full h-auto mx-auto' alt="Imagen de fondo" />
          </div>

          {/* Septimo conjunto de imágenes */}
          <div className='relative mb-20'>
            {/* Imagen de fondo */}
            <img src={seven} className='w-full h-[400px] md:h-full' alt="Imagen de fondo" />

            {/* Contenedor absoluto para el título y el texto */}
            <div className='absolute inset-0 flex flex-col items-center justify-center p-4 '>
              {/* Título (Imagen seven_two) */}
              <img src={seven_two} className='w-3/5 h-auto mb-4' alt="Título" />
        ...
        <div className='relative'>
            {/* Imagen 1*/}
            {/* Imagen de fondo */}
            <img src={eigth} className='md:w-4/6 md:h-auto w-full h-[200px] mx-auto' alt="Imagen de fondo" />

            {/* Contenedor absoluto para el título y el texto */}
            <div className='absolute inset-0 flex flex-col items-center justify-center p-4 '>
              {/* Título (Imagen seven_two) */}
              <img src={eigth_three} className='w-2/5 h-auto mb-4' alt="Título" />
        ...
        <div className='relative mb-20'>
            {/* Imagen 1*/}
            {/* Imagen de fondo */}
            <img src={eigth_two} className='md:w-4/6 md:h-auto w-full h-[200px] mx-auto' alt="Imagen de fondo" />

            {/* Contenedor absoluto para el título y el texto */}
            <div className='absolute inset-0 flex flex-col items-center justify-center p-4 '>
              {/* Título (Imagen seven_two) */}
              <img src={eigth_four} className='w-2/5 h-auto mb-4' alt="Título" />
         ...
         <div className='relative mb-20'>
            <img src={nine} className='md:w-4/5 w-full h-auto mx-auto' alt="Imagen de fondo" />
          </div>

          {/* Decimo conjunto de imágenes */}
          <div className='relative mb-20'>
            <img src={ten} className='w-auto h-auto mx-auto' alt="Imagen de fondo" />
            <div className='absolute inset-0 flex items-center justify-center p-4'>
          ...
          <div className='relative mb-20'>
            {/* Imagen de fondo */}
            <img src={eleven} className='md:w-5/6 w-full h-auto mx-auto mb-10' alt="Imagen de fondo" />
          ...
          <div className='relative mb-20'>
            {/* Imagen de fondo */}
            <img src={twelve} className=' w-auto h-auto mx-auto mb-10' alt="Imagen de fondo mb-20" />
            <img src={twelve_two} className='md:w-1/6 w-3/6 h-auto mx-auto mb-10' alt="Imagen de fondo" />
          </div>
